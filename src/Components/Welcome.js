...
const WelcomePage = () => {
  ...
  const containerStyle = {
    ...
    justifyContent: 'center',
    height: '95vh',
    backgroundImage: 'url("https://img.freepik.com/free-photo/stacks-coins-arranged-bar-graph_35913-2518.jpg?w=996&t=st=1707123805~exp=1707124405~hmac=e6905cc1711f1b8eb2765165f037f001f61cb5cf3a287d89b021891aff4fb576")',
    backgroundSize: 'cover',
    backgroundPosition: 'center',
    padding: '20px',
  };
